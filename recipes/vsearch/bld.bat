...
powershell -Command "Expand-Archive -Force '%SRC_DIR%\vsearch-2.30.0-win-x86_64.zip' '%SRC_DIR%'"

copy "%SRC_DIR%\vsearch-2.30.0-win-x86_64\bin\vsearch.exe" "%PREFIX%\Scripts\vsearch.exe"
if %ERRORLEVEL% NEQ 0 (
